...
module.exports = {
    ...
    /**
     * @description To find the prime factorials of the number.
     * 
     * @param {number} num 
     */
    ...
    /**
     * @description To generate the random number between the given range.
     * 
     * @param {number} min 
     * @param {number} max 
     * 
    ...
    /**
     * @description To create a array of distinct random numbers.
     * 
     * @param {number} num
     * 
     * @returns Array. 
    ...
    /**
     * @description To check wheather the number present in the array.
     * 
     * @param {number} num 
     * @param {Array} arr 
     * 
    ...
    ,
    /**
     * @description To create two dimensional array.
     * 
     * @param {number} row 
     * @param {number} column
     * 
    ...
    /**
     * @description To check the triplet whose sum is Zero.
     * 
     * @param {Array} arr.
     */
    triplet(arr) {
    ...
    /**
     * @description To calculate the distance using Euclidean formulae.
     * 
     * @param {number} x 
     * @param {number} y 
     * 
    ...
    /**
     * @description Get the time from the system.
     */
    timeSecond() {
        var date = new Date
    ...
    /**
     * @description Initialize the game with - in all the array elements.
     */
    intializeGame() {
        var game = [];
        for (let i = 0; i <= 2; i++) {
    ...
    */
    ...
    /**
     * @description To calculate the root of the equation.
     * 
     * @param {number} a 
     * @param {number} b `
     * @param {number} c 
     * 
     * @returns Two values which are root of the equation.
     */
    quadratic(a, b, c) {
        var root = [];
    ...
    /**
     * @description To calculate the wind chill.
     * 
     * @param {Temperature} t 
     * @param {Wind Speed} v 
     * 
