...
/**
 * @description To use the file system.
 */
...
module.exports = {
    ...
    /**
     * @description To add the person details to the database.
     * 
     * @param {object} data 
     */
    addPerson(data) {
    ...
    /**
     * @description To display the content of the database.
     * 
     * @param {object} data 
     */
    displ(data) {
    ...
    /**
     * @description To delete the particular person detail from the database.
     * 
     * @param {object} data 
     */
    deleted(data) {
    ...
    /**
     * @description To sort the person deatils based on the zip code.
     * @param {object} data 
     */
    sortingZip(data) {
    ...
    /**
     * @description To the object by taking first name.
     * 
     * @param {object} data 
     */
    sortingName(data) {
    ...
    /**
     * @description To update the data of particular person.
     * 
     * @param {object} data 
     */
    update(data) {
    ...
    /**
     * @description To save the modified data in the object.
     * 
     * @param {object} data 
     */
    save(data) {
